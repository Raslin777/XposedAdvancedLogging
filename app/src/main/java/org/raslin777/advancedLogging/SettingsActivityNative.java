 ...
 */
public class SettingsActivityNative extends PreferenceActivity {
	...
	private Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object value) {
			if (preference.getKey().contains("GrepMethodRedirect")) {
				SettingsActivityNative.this.findPreference("MethodRedirect").setEnabled(Boolean.FALSE.equals(value));
			}
			if (preference.getKey().equals("MethodRedirect")) {
				SettingsActivityNative.this.findPreference("PlaceHolding").setEnabled(Boolean.TRUE.equals(value));
                SettingsActivityNative.this.findPreference("DecodeHex").setEnabled(Boolean.TRUE.equals(value));
			}

            if (preference.getKey().equals("DumpMethodReturn")) {
                SettingsActivityNative.this.findPreference("MethodReturnClass").setEnabled(Boolean.TRUE.equals(value));
                SettingsActivityNative.this.findPreference("MethodReturnMethod").setEnabled(Boolean.TRUE.equals(value));
                SettingsActivityNative.this.findPreference("MethodReturnChange").setEnabled(Boolean.TRUE.equals(value));
            }

            if (preference.getKey().equals("LogAllClasses")) {
                SettingsActivityNative.this.findPreference("GrepClass").setEnabled(Boolean.TRUE.equals(value));
            }
